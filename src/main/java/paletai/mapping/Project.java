...
public class Project {
    ...
    /** Cached fonts — created once to avoid per-frame and per-call allocation */
    PFont uiFont14;
    PFont uiFont16;
    PFont uiFont20;
	...
	public Project(PApplet p, String name) {
		...
		uiFont14 = mainApplet.createFont("NeueMachina-Regular.otf", 14, true);
		uiFont16 = mainApplet.createFont("NeueMachina-Regular.otf", 16, true);
		uiFont20 = mainApplet.createFont("NeueMachina-Regular.otf", 20, true);
		initializeDisplays();
...
//		PApplet.println("save to file");
	...
	void addSelectSceneButton(int index) {
	    ...
	    // ---- Styling label ----
        //PFont myFont = uiFont20;
//
	    t.getCaptionLabel().setFont(uiFont20);
	...
	void createMediaButtons() {
	    ...
	    for (int i = 0; i < mediaFiles.size(); i++) {
	        ...
	        // ---- Styling ----
	        b.getCaptionLabel().setFont(uiFont16).toUpperCase(false);      // font
    ...
    void createGeneratorButtons() {
        ...
        //PFont myFont = uiFont14;
        generatorList.getCaptionLabel().setFont(uiFont14).setVisible(false).toUpperCase(false);
        ...
        for (int i = 0; i < availableGenerators.size(); i++) {
            ...
            // ---- Styling ----
            b.getCaptionLabel().setFont(uiFont14).toUpperCase(false);      // font
            b.setColorBackground(mainApplet.color(91, 91, 91)); // normal background
            b.setColorForeground(mainApplet.color(202, 195, 226)); // hover color
            b.setColorActive(mainApplet.color(171, 128, 255));   // pressed color
            b.setColorLabel(mainApplet.color(255));              // text color
