...
/**
 *
 * Exemplo que permite o mapeamento de muliplas cenas
 *
 * --- controles ---
...
void setup() {
  ...
  Scene cena1 = new Scene(this, 1); //cena inicial para aguardar o público
  cena1.addMediaItem(new MediaItem(this, dataPath("branco.jpg"), 1));
  cenas.add(cena1);
  
  Scene cena2 = new Scene(this, 2);
  cena2.addMediaItem(new MediaItem(this, dataPath("cores.mp4"), 2));
  cenas.add(cena2);

  Scene cena3 = new Scene(this, 3);
  cena3.addMediaItem(new MediaItem(this, dataPath("branco.jpg"), 3));
  cenas.add(cena3);

  Scene cena4 = new Scene(this, 4);
  cena4.addMediaItem(new MediaItem(this, dataPath("porDoSol.mp4"), 4));
  cenas.add(cena4);

  Scene cena5 = new Scene(this, 5);
  cena5.addMediaItem(new MediaItem(this, dataPath("tchau.mp4"), 5));
  cenas.add(cena5);
  
  Scene cena6 = new Scene(this, 6);
  cena6.addMediaItem(new MediaItem(this, dataPath("branco.jpg"), 5));
  cenas.add(cena6);
...
void transitionEffect() {
  ...
  if (carregarAjustes) cenas.get(nextSceneIndex).loadAll();
  pushStyle();
